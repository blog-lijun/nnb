...
Component({
    ...
    properties: {
        ...
        tabBarLineColor: { type: String, value: 'rgb(246,246,246)' },
        tabBarInactiveTextColor: { type: String, value: '#000000' },
        //tabBarActiveTextColor: { type: String, value: '#ff0000' },选中文本颜色
        tabBarActiveTextColor: { type: String, value: 'rgb(0,157,255)' },
        //tabBarInactiveBgColor: { type: String, value: '#eeeeee' },
        tabBarInactiveBgColor: { type: String, value: '#ffffff' },
        tabBarActiveBgColor: { type: String, value: '#eeeee' },
